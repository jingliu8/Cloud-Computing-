...
class Config(object):  
  ...
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "arn:aws:sns:us-east-1:127134666975:jing3_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:127134666975:jing3_job_results"
  AWS_SNS_RESULTS_RESTORE_TOPIC = \
    "arn:aws:sns:us-east-1:127134666975:jing3_results_restore"

  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "jing3_annotations"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "jing3@ucmpcs.org"
